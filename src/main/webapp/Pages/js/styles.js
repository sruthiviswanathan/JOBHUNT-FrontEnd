...
function setValue1(id){
	 document.getElementById("update"+id).value = "UPDATE";
	 document.getElementById("do"+id).value = "UPDATE";
	
}
function setValue2(id){	
	 document.getElementById("delete"+id).value = "DELETE";
